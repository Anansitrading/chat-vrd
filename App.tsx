...
const App: React.FC = () => {
  ...
  const { isSpeaking, isTtsEnabled, setIsTtsEnabled, speak, stop } = useTextToSpeech();
  ...
  }, [chat, isTtsEnabled, speak, stop]);
  
  return (
    <div className="flex flex-col h-screen bg-gray-900 text-gray-100 font-sans">
      <Header isTtsEnabled={isTtsEnabled} setIsTtsEnabled={setIsTtsEnabled} isSpeaking={isSpeaking} stopSpeech={stop} />
